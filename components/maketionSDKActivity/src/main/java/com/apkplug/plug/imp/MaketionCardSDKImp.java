...
import com.android.maketionsdk.CardPictureActivity;
...
public class MaketionCardSDKImp implements IMaketionCardSDK {
	...
	public MaketionCardSDKImp(Context context) {
		mContext=context;
	...
	public void startPictureActivity() {
		Log.e("", "startPictureActivity");
		Intent intent=new Intent();
		intent.setClass(mContext, CardPictureActivity.class);
